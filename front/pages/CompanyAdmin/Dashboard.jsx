...
import CompanyAdminHierarchy from './Hierarchy';
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        if (response.ok) {
          const designationsData = await response.json();
          const designationsList = designationsData.data || designationsData || [];
          setDesignations(designationsList);
          console.log('Designations loaded for dashboard:', designationsList);
          
          // Update stats with designation count
          setDashboardStats(prev => ({
            ...prev,
            totalDesignations: designationsList.length
          }));
        } else {
          const errorData = await response.json().catch(() => ({}));
          console.error('API Error fetching designations for dashboard:', {
        ...
        console.error('Error fetching designations for dashboard:', error);
      } finally {
      ...
      try {
        ...
        if (response.ok) {
          ...
          console.log('Locations loaded for dashboard:', locationsList);
          
          // Update stats with location count
          setDashboardStats(prev => ({
            ...prev,
          ...
          const errorData = await response.json().catch(() => ({}));
          console.error('API Error fetching locations for dashboard:', {
            status: response.status,
            statusText: response.statusText,
            error: errorData,
        ...
        console.error('Error fetching locations for dashboard:', error);
      } finally {
    ...
    <div className="dashboard-layout">
      <aside className="sidebar">
        ...
        <nav>
          ...
          <div 
            className={`nav-item ${location.pathname.includes('/designation') ? 'active' : ''}`}
          ...
          <div 
            className={`nav-item ${location.pathname.includes('/location') ? 'active' : ''}`}
      ...
      <main className="dashboard-content">
        ...
        <div className="content-wrapper">
          <Routes>
            ...
            <Route path="hierarchy" element={<CompanyAdminHierarchy />} />
