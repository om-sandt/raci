  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/company-admin/designation-creation" element={<PrivateRoute element={<CreateDesignation />} />} />
        <Route path="/company-admin/designation-management" element={<PrivateRoute element={<DesignationManagement />} />} />
        
        {/* Location Management Routes */}
        <Route path="/company-admin/location-creation" element={<PrivateRoute element={<CreateLocation />} />} />
        <Route path="/company-admin/location-management" element={<PrivateRoute element={<LocationManagement />} />} />

        {/* User Management Routes */}
        <Route path="/company-admin/user-creation" element={<PrivateRoute element={<CreateUser />} />} />
        <Route path="/company-admin/user-management" element={<PrivateRoute element={<UserManagement />} />} />
